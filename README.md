...
- <b>normal</b>: reads data from a file generated by the [ecowitt_http_gateway](https://github.com/iz0qwm/ecowitt_http_gateway/blob/master/README.md#ecowitt_http_gateway)<br>
...
[ecowitt]
     ...
     address = 192.168.2.185               # IP address of the PC where weewx is running in server mode, to which GW1000 will connect to                
     port = 9999                           # port to which GW1000 will connect to
</b>
</pre>
